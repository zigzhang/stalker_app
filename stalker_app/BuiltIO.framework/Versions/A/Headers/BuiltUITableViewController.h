...
/**
 @abstract Deprecated the use of this method. Its will be internally handle by BuiltUITableViewController. Currently only 1 section is supported.
 @param tableView An object representing the table view requesting this information.
 */
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView UNAVAILABLE_ATTRIBUTE;

/**
 @abstract Deprecated the use of this method. Its will be internally handle by BuiltUITableViewController
